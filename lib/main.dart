...
import 'package:flutter_application_1/Screens/home_screen_list_view_builder.dart';
...
//import 'package:flutter_application_1/home_screen_text_form_field.dart';
...
void main() async {
  ...
  try {
    ...
    // Web/desktop options not in firebase_options.dart — app runs without Firebase.
  }
  runApp(const MyApp());
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const HomeScreenListViewBuilder(),
    );
  }
}
